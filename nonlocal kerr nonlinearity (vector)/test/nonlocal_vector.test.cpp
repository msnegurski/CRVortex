...
int main(void)
{
    ...
    FILE *fp_2;
    FILE *fp_t;
    fp_1=fopen("sequence1_test.txt","w");
    fp_2=fopen("sequence2_test.txt","w");
    fp_t=fopen("sequencet_test.txt","w");
    int i,j,k;
    ...
    while(((S1-1)*(S1-1))>0.000000000000001)
    {
    norm_p_1=0.0;
    norm_1=0.0;
    norm_p_2=0.0;
    ...
    for (i=1; i<n; i++)
        {
        norm_p_3+=(theta[i]*theta[i]*i*delta*delta);
        }
    ...
    S1=pow(((norm_p_1+norm_p_2)/(norm_1+norm_2)),0.75);
    ...
    printf("%lf %lf %lf\n", test_1,test_2,test_3); 
       ...
       printf("%lf %lf\n",theta[1],top_3[0]);
    test_1+=mid_1[0]*psi_1[0]+top_1[0]*psi_1[2]-theta[0]*psi_1[0];
    test_2+=mid_2[0]*psi_2[0]+top_2[0]*psi_2[2]-theta[0]*psi_2[0];
